...
class MediaUploader
{
    ...
    public function upload(?string $disk = null): Media
    {
        ...
        try {
            ...
            if (is_string($this->source) && filter_var($this->source, FILTER_VALIDATE_URL)) {
            ...
            app(MediaContract::class)->validateUploadedFile($this->source, $this->filesystem());
     ...
     *
     * @return string|null The name of the object, or the file name from the source if the `name` property is not set.
     */
