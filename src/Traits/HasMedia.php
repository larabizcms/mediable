...
trait HasMedia
{
    ...
    public function setMedia(Media|int $media, string $channel = 'default'): static
    {
     ...
     *
     * @param  Media|string|int  $media The media object to parse, or its ID, or a path to the media file.
     * @return int                The ID of the media object.
     */
    protected function parseMediaId(Media|string|int $media): int
    {
